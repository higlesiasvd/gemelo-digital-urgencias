...
export function ModeloPage() {
    const hospitalState = useHospitalById('modelo');
        ...
        <Stack gap="lg">
            <Card className="glass-card" style={{ background: cssVariables.glassBg, border: `1px solid ${cssVariables.glassBorder}` }}>
                <Group justify="space-between">
                    <Group gap="md">
                        <ThemeIcon size={60} radius="xl" variant="gradient" gradient={{ from: 'orange', to: 'red', deg: 135 }}><IconBuildingHospital size={32} /></ThemeIcon>
                        <div><Title order={2}>Hospital HM Modelo</Title><Text c="dimmed">Hospital Privado</Text><Badge mt="xs" variant="light" color="gray">Capacidad Fija</Badge></div>
                    </Group>
